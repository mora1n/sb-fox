...
const en: Record<string, string> = {
  ...
  '检测到 sing-box 1.14.0 设置提示，保存后请用内核校验': 'sing-box 1.14.0 setting warnings detected; validate with the kernel after saving',
  '原始出站 JSON': 'Raw outbound JSON',
  '用于编辑结构化表单未覆盖的字段；JSON 语法错误会阻止保存，schema 提示不会阻止保存。': 'Use this to edit fields not covered by the structured form. JSON syntax errors block saving; schema warnings do not.',
  ...
  '未刷新': 'Not refreshed',
  '立即刷新': 'Refresh now',
  '刷新设置已保存': 'Refresh settings saved',
  '订阅已刷新': 'Subscription refreshed',
  '订阅刷新失败': 'Subscription refresh failed',
